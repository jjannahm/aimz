...
if (!html.includes('manifest.webmanifest')) {
  ...
  const branding = [
    ...
    '<link rel="preload" href="/fonts/Roboto_400Regular.ttf" as="font" type="font/ttf" crossorigin/>',
    '<link rel="preload" href="/fonts/Roboto_700Bold.ttf" as="font" type="font/ttf" crossorigin/>',
    '<meta name="application-name" content="AIMZ Egypt"/>',
    '<meta name="description" content="Invitation-only access to AIMZ Egypt fixtures, results, team information, and academy operations."/>',
    '<meta property="og:type" content="website"/>',
    '<meta property="og:site_name" content="AIMZ Egypt"/>',
    '<meta property="og:title" content="AIMZ Egypt | Girls’ football scores and academy updates"/>',
    '<meta property="og:description" content="Invitation-only access to AIMZ Egypt fixtures, results, team information, and academy operations."/>',
    '<meta property="og:image" content="/aimz-icon-512.png"/>',
