  ...
  return (
    ...
    >
      <View style={styles.teamSide}>
        ...
        <TeamAvatar logoUrl={match.home_team?.logo_url} name={homeName} size={compact ? 36 : 40} tone="accent" />
      </View>
      ...
      <View style={styles.teamSide}>
        <TeamAvatar logoUrl={match.away_team?.logo_url} name={awayName} size={compact ? 36 : 40} tone="light" />
