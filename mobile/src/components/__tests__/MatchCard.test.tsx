...
const match: Match = {
  ...
  home_team: { id: 'home', name: 'AIMZ Navy', squad_code: 'RTS S14', age_group: 'U14', season: '2026/27', is_aimz: true, is_active: true, logo_key: null, coach: null, assistant_coach: null, created_at: '', updated_at: '' },
  away_team: { id: 'away', name: 'Cairo Stars', squad_code: null, age_group: null, season: null, is_aimz: false, is_active: true, logo_key: null, coach: null, assistant_coach: null, created_at: '', updated_at: '' },
