...
const stylesheet = (colors: ThemeColors) => StyleSheet.create({
  ...
  shell: { alignItems: 'center', backgroundColor: colors.surface, borderColor: colors.border, borderRadius: theme.radius.md, borderWidth: 1, flexDirection: 'row', gap: theme.spacing.sm, justifyContent: 'space-between', minHeight: theme.size.field, paddingHorizontal: theme.spacing.md },
  shellOpen: { borderColor: colors.accent },
  shellError: { borderColor: colors.error },
  pressed: { opacity: 0.7 },
  value: { color: colors.textPrimary, flex: 1, fontFamily: theme.font.regular, fontSize: theme.type.body },
  ...
  monthLabel: { color: colors.textPrimary, fontFamily: theme.font.semibold, fontSize: theme.type.body },
  ...
  weekday: { color: colors.textMuted, flexBasis: '14.28%', fontFamily: theme.font.bold, fontSize: theme.type.caption, textAlign: 'center' },
  ...
  dayText: { color: colors.textPrimary, fontFamily: theme.font.mono, fontVariant: ['tabular-nums'] },
  daySelectedText: { color: colors.onAccent, fontFamily: theme.font.bold },
  ...
  time: { color: colors.textPrimary, flex: 1, fontFamily: theme.font.monoBold, fontSize: theme.type.heading, fontVariant: ['tabular-nums'], textAlign: 'center' },
