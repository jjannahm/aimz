...
const schema = z.object({ email: z.email('Enter a valid email.'), code: z.string().regex(/^\s?\d{6}$/, 'Enter the six-digit code.'), password: z.string().min(8, 'Use at least 8 characters.') });
