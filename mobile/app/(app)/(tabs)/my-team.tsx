...
export default function HubScreen() {
  ...
  return <Screen title="Hub"><SegmentedControl label="Hub section" onChange={setSelected} options={sections} value={selected} />{selected === 'schedule' ? <ScheduleSection /> : <AnnouncementsSection />}</Screen>;
}
