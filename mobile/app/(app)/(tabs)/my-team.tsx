...
import { StatsSection } from '@/src/components/myTeam/StatsSection';
import { Screen } from '@/src/components/Screen';
import { theme, type ThemeColors } from '@/src/theme';
import { useThemedStyles } from '@/src/theme/ThemeProvider';

const sections = [{ key: 'schedule', label: 'Schedule' }, { key: 'stats', label: 'Stats' }, { key: 'announcements', label: 'Announcements' }] as const;
