...
function ResourceFields({ control, errors, resource, setValue, teams, competitions, editingId }: { control: any; errors: any; resource: Resource; setValue: any; teams: Team[]; competitions: Competition[]; editingId: string | null }) {
  const styles = useThemedStyles(stylesheet);
