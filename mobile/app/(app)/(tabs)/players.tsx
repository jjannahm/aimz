...
// Ionicons render as tofu boxes in the web export, so navigation affordances use text glyphs.
function Chevron() {
  return <Text accessibilityElementsHidden style={styles.chevron}>›</Text>;
}
...
function TeamsSection() {
  ...
  return <View style={styles.stack}>
    <Pressable accessibilityLabel="Back to all teams" accessibilityRole="button" onPress={() => setOpenTeam(null)} style={({ pressed }) => [styles.back, pressed && styles.pressed]}>
      <Text accessibilityElementsHidden style={styles.backChevron}>‹</Text>
