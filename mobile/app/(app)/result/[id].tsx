...
const stylesheet = (colors: ThemeColors) => StyleSheet.create({ away: { textAlign: 'right' }, card: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: theme.radius.lg, borderWidth: 1, gap: theme.spacing.lg, padding: theme.size.cardPadding }, score: { flex: 1 }, scores: { flexDirection: 'row', gap: theme.spacing.md }, team: { color: colors.textPrimary, flex: 1, fontFamily: theme.font.bold, fontSize: theme.type.body }, teams: { alignItems: 'center', flexDirection: 'row', gap: theme.spacing.sm }, vs: { color: colors.textMuted, fontFamily: theme.font.semibold } });
