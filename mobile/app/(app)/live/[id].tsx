...
const eventGroups: { label: string; value: EventGroup; icon?: keyof typeof Ionicons.glyphMap }[] = [
  { label: 'Goal', value: 'goal', icon: 'football' }, { label: 'Assist', value: 'assist', icon: 'sparkles-outline' }, { label: 'Cards', value: 'cards' }, { label: 'Sub', value: 'substitution', icon: 'swap-horizontal' },
];
