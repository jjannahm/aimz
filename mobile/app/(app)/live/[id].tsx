...
const eventOptions: { label: string; value: EventType; icon: keyof typeof Ionicons.glyphMap }[] = [
  { label: 'Goal', value: 'goal', icon: 'football' }, { label: 'Yellow', value: 'yellow_card', icon: 'square' }, { label: 'Red', value: 'red_card', icon: 'square' }, { label: 'Sub', value: 'substitution', icon: 'swap-horizontal' },
];
