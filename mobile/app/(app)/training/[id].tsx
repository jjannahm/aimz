...
export default function TrainingDetailScreen() {
  ...
  // Taking the register is the coach's job; a player reads the replies below it.
  const { user } = useAuth();
